    ...
    <>
      ...
      <MainContainer>
        <TextParagraph>
          ...
          service telles que l&apos;activité du compte (exemple: stockage
          occupé, nombre d&apos;entrées, mesures prises), les données données
          affichées ou cliquées (exemple: liens, éléments de l&apos;interface
          utilisateur), et d&apos;autres informations pour vous identifier
          (exemple: type de navigateur, adresse IP, date et heure de
          l&apos;accès, URL de référence).
          <br />
          <br />
